!(function() {
  ...
  function z(n, t) {
    ...
    return (
      ...
      null == t
        ? n.local ? r : e
        : 'function' == typeof t ? (n.local ? o : a) : n.local ? i : u
    )
  }
  function L(n) {
  ...
  function cn(n, t, e) {
    function r(n) {
      return (
        ...
        60 > n
          ? i + (a - i) * n / 60
          : 180 > n ? a : 240 > n ? i + (a - i) * (240 - n) / 60 : i
      )
    }
    function u(n) {
  ...
  function hn(n, t, e) {
    return this instanceof hn
      ...
      : arguments.length < 2
        ? n instanceof hn
          ? new hn(n.l, n.a, n.b)
          : n instanceof sn ? fn(n.h, n.c, n.l) : Sn((n = yn(n)).r, n.g, n.b)
        : new hn(n, t, e)
  }
  function gn(n, t, e) {
    var r = (n + 16) / 116,
    ...
    return (
      ...
      (e.rangePoints = function(u, o) {
        ...
        var l = u[0],
          c = u[1],
          s =
            n.length < 2 ? ((l = (l + c) / 2), 0) : (c - l) / (n.length - 1 + o)
        return (
          (i = r(l + s * o / 2, s)),
          (a = 0),
      ...
      (t = Pi(n[o], n[o + 1])),
        Ma(t) < Pa
          ...
          : ((e = a[o] / t),
            ...
            (u = e * e + r * r),
            u > 9 &&
              ((u = 3 * t / Math.sqrt(u)), (a[o] = u * e), (a[o + 1] = u * r)))
    for (o = -1; ++o <= l; )
      (u =
  ...
  ;(oa.geo.bounds = (function() {
    ...
    function t(t, e) {
      ...
      if (m) {
        ...
        d
          ? p > t ? o(s, t) > o(s, h) && (h = t) : o(t, h) > o(s, h) && (s = t)
          : h >= s
            ? (s > t && (s = t), t > h && (h = t))
            : t > p
              ? o(s, t) > o(s, h) && (h = t)
      ...
      return (
        (n.invert = function(n) {
          ...
          return (u >= 0.12 && 0.234 > u && r >= -0.425 && -0.214 > r
            ? a
            : u >= 0.166 && 0.234 > u && r >= -0.214 && -0.115 > r ? o : i
          ).invert(n)
        }),
        (n.stream = function(n) {
          var t = i.stream(n),
  ...
  ;(oa.geo.path = function() {
    ...
    return (
      ...
      (n.centroid = function(n) {
        return (
          ...
          Uo
            ? [Do / Uo, Po / Uo]
            : Ro ? [qo / Ro, To / Ro] : Lo ? [Co / Lo, zo / Lo] : [NaN, NaN]
        )
      }),
      (n.bounds = function(n) {
        return (
    ...
    (oa.geo.graticule = function() {
      ...
      return (
        ...
        n
          .majorExtent([[-180, -90 + Pa], [180, 90 - Pa]])
          .minorExtent([[-180, -80 - Pa], [180, 80 + Pa]])
      )
    }),
  ...
  ;(oa.interpolate = Mr),
    (oa.interpolators = [
      function(n, t) {
        var e = typeof t
        return ('string' === e
          ? uo.has(t.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(t) ? vr : yr
          : t instanceof on
            ? vr
            : Array.isArray(t) ? xr : 'object' === e && isNaN(t) ? dr : mr)(
          n,
          t
        )
      }
  ...
  ;(oa.layout.histogram = function() {
    ...
    (oa.layout.pack = function() {
      function n(n, i) {
        ...
        return (
          Cu(o, l / 2, c / 2, t ? 1 : 1 / Math.max(2 * o.r / l, 2 * o.r / c)), a
        )
      }
      var t,
